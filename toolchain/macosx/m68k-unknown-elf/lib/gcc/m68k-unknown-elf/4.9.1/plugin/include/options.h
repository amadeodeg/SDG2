...
enum opt_code
{
  ...
  /* OPT_m5200 = 1066, */                    /* -m5200 */
  /* OPT_m5206e = 1067, */                   /* -m5206e */
  /* OPT_m528x = 1068, */                    /* -m528x */
  /* OPT_m5307 = 1069, */                    /* -m5307 */
  /* OPT_m5407 = 1070, */                    /* -m5407 */
  /* OPT_m68000 = 1071, */                   /* -m68000 */
  /* OPT_m68010 = 1072, */                   /* -m68010 */
  /* OPT_m68020 = 1073, */                   /* -m68020 */
  OPT_m68020_40 = 1074,                      /* -m68020-40 */
  OPT_m68020_60 = 1075,                      /* -m68020-60 */
  /* OPT_m68030 = 1076, */                   /* -m68030 */
  /* OPT_m68040 = 1077, */                   /* -m68040 */
  /* OPT_m68060 = 1078, */                   /* -m68060 */
  /* OPT_m68302 = 1079, */                   /* -m68302 */
  /* OPT_m68332 = 1080, */                   /* -m68332 */
  OPT_m68851 = 1081,                         /* -m68851 */
  OPT_m68881 = 1082,                         /* -m68881 */
  OPT_malign_int = 1083,                     /* -malign-int */
  OPT_march_ = 1084,                         /* -march= */
  OPT_mbitfield = 1085,                      /* -mbitfield */
  /* OPT_mc68000 = 1086, */                  /* -mc68000 */
  /* OPT_mc68020 = 1087, */                  /* -mc68020 */
  /* OPT_mcfv4e = 1088, */                   /* -mcfv4e */
  /* OPT_mcpu32 = 1089, */                   /* -mcpu32 */
  OPT_mcpu_ = 1090,                          /* -mcpu= */
  OPT_mdiv = 1091,                           /* -mdiv */
  OPT_mfidoa = 1092,                         /* -mfidoa */
  OPT_mhard_float = 1093,                    /* -mhard-float */
  OPT_mid_shared_library = 1094,             /* -mid-shared-library */
  OPT_mnobitfield = 1095,                    /* -mnobitfield */
  OPT_mnortd = 1096,                         /* -mnortd */
  OPT_mnoshort = 1097,                       /* -mnoshort */
  OPT_mpcrel = 1098,                         /* -mpcrel */
  OPT_mrtd = 1099,                           /* -mrtd */
  OPT_msep_data = 1100,                      /* -msep-data */
  OPT_mshared_library_id_ = 1101,            /* -mshared-library-id= */
  OPT_mshort = 1102,                         /* -mshort */
  OPT_msoft_float = 1103,                    /* -msoft-float */
  OPT_mstrict_align = 1104,                  /* -mstrict-align */
  OPT_mtune_ = 1105,                         /* -mtune= */
  OPT_mxgot = 1106,                          /* -mxgot */
  OPT_mxtls = 1107,                          /* -mxtls */
  OPT_n = 1108,                              /* -n */
  OPT_no_canonical_prefixes = 1109,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1110,              /* -no-integrated-cpp */
  OPT_nocpp = 1111,                          /* -nocpp */
  OPT_nodefaultlibs = 1112,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1113,                   /* -nostartfiles */
  OPT_nostdinc = 1114,                       /* -nostdinc */
  OPT_nostdinc__ = 1115,                     /* -nostdinc++ */
  OPT_nostdlib = 1116,                       /* -nostdlib */
  OPT_o = 1117,                              /* -o */
  OPT_p = 1118,                              /* -p */
  OPT_pass_exit_codes = 1119,                /* -pass-exit-codes */
  /* OPT_pedantic = 1120, */                 /* -pedantic */
  OPT_pedantic_errors = 1121,                /* -pedantic-errors */
  OPT_pg = 1122,                             /* -pg */
  OPT_pie = 1123,                            /* -pie */
  OPT_pipe = 1124,                           /* -pipe */
  OPT_print_file_name_ = 1125,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1126,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1127,          /* -print-multi-directory */
  OPT_print_multi_lib = 1128,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1129,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1130,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1131,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1132,               /* -print-prog-name= */
  OPT_print_search_dirs = 1133,              /* -print-search-dirs */
  OPT_print_sysroot = 1134,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1135,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1136,                          /* -quiet */
  OPT_r = 1137,                              /* -r */
  OPT_remap = 1138,                          /* -remap */
  OPT_s = 1139,                              /* -s */
  OPT_s_bc_abi = 1140,                       /* -s-bc-abi */
  OPT_save_temps = 1141,                     /* -save-temps */
  OPT_save_temps_ = 1142,                    /* -save-temps= */
  OPT_shared = 1143,                         /* -shared */
  OPT_shared_libgcc = 1144,                  /* -shared-libgcc */
  /* OPT_specs = 1145, */                    /* -specs */
  OPT_specs_ = 1146,                         /* -specs= */
  OPT_static = 1147,                         /* -static */
  OPT_static_libasan = 1148,                 /* -static-libasan */
  OPT_static_libgcc = 1149,                  /* -static-libgcc */
  OPT_static_libgcj = 1150,                  /* -static-libgcj */
  OPT_static_libgfortran = 1151,             /* -static-libgfortran */
  OPT_static_libgo = 1152,                   /* -static-libgo */
  OPT_static_liblsan = 1153,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1154,               /* -static-libstdc++ */
  OPT_static_libtsan = 1155,                 /* -static-libtsan */
  OPT_static_libubsan = 1156,                /* -static-libubsan */
  /* OPT_std_c__03 = 1157, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1158, */                /* -std=c++0x */
  OPT_std_c__11 = 1159,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1160, */                /* -std=c++14 */
  OPT_std_c__1y = 1161,                      /* -std=c++1y */
  OPT_std_c__98 = 1162,                      /* -std=c++98 */
  OPT_std_c11 = 1163,                        /* -std=c11 */
  /* OPT_std_c1x = 1164, */                  /* -std=c1x */
  /* OPT_std_c89 = 1165, */                  /* -std=c89 */
  OPT_std_c90 = 1166,                        /* -std=c90 */
  OPT_std_c99 = 1167,                        /* -std=c99 */
  /* OPT_std_c9x = 1168, */                  /* -std=c9x */
  OPT_std_f2003 = 1169,                      /* -std=f2003 */
  OPT_std_f2008 = 1170,                      /* -std=f2008 */
  OPT_std_f2008ts = 1171,                    /* -std=f2008ts */
  OPT_std_f95 = 1172,                        /* -std=f95 */
  OPT_std_gnu = 1173,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1174, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1175, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1176,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1177, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1178,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1179,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1180,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1181, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1182, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1183,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1184,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1185, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1186, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1187,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1188, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1189, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1190, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1191,                     /* -std=legacy */
  OPT_symbolic = 1192,                       /* -symbolic */
  OPT_t = 1193,                              /* -t */
  OPT_time = 1194,                           /* -time */
  OPT_time_ = 1195,                          /* -time= */
  OPT_traditional = 1196,                    /* -traditional */
  OPT_traditional_cpp = 1197,                /* -traditional-cpp */
  OPT_trigraphs = 1198,                      /* -trigraphs */
  OPT_u = 1199,                              /* -u */
  OPT_undef = 1200,                          /* -undef */
  OPT_v = 1201,                              /* -v */
  OPT_version = 1202,                        /* -version */
  OPT_w = 1203,                              /* -w */
  OPT_wrapper = 1204,                        /* -wrapper */
  OPT_x = 1205,                              /* -x */
  OPT_z = 1206,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
