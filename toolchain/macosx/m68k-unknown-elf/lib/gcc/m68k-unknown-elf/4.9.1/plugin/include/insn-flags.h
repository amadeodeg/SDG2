...
#define HAVE_tstxf_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
#define HAVE_cmpdi 1
...
#define HAVE_floatsixf2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_floathixf2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_floatqixf2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_ftruncxf2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_fixxfqi2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_fixxfhi2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_fixxfsi2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_addxf3_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_subxf3_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_fmulxf3_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_divxf3_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_negxf2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_sqrtxf2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
#define HAVE_absxf2_cf ((TARGET_COLDFIRE_FPU) && (TARGET_68881))
...
extern rtx        gen_tstxf_cf                        (rtx, rtx);
...
extern rtx        gen_floatsixf2_cf                   (rtx, rtx);
...
extern rtx        gen_floathixf2_cf                   (rtx, rtx);
...
extern rtx        gen_floatqixf2_cf                   (rtx, rtx);
...
extern rtx        gen_ftruncxf2_cf                    (rtx, rtx);
...
extern rtx        gen_fixxfqi2_cf                     (rtx, rtx);
...
extern rtx        gen_fixxfhi2_cf                     (rtx, rtx);
...
extern rtx        gen_fixxfsi2_cf                     (rtx, rtx);
...
extern rtx        gen_addxf3_cf                       (rtx, rtx, rtx);
...
extern rtx        gen_subxf3_cf                       (rtx, rtx, rtx);
...
extern rtx        gen_fmulxf3_cf                      (rtx, rtx, rtx);
...
extern rtx        gen_divxf3_cf                       (rtx, rtx, rtx);
...
extern rtx        gen_negxf2_cf                       (rtx, rtx);
...
extern rtx        gen_sqrtxf2_cf                      (rtx, rtx);
...
extern rtx        gen_absxf2_cf                       (rtx, rtx);
