/********************************************************************************/
/* Este es un prorama de ejemplo sobre cómo se puede enviar un SMS enviando 	*/
/* comandos AT a un terminal comercial como puede ser el modem MC35i disponible	*/
/* en el laboratorio.															*/
/* El programa no ofrece ninguna funcionalidad mas salvo la mencionada de enviar*/
/* un SMS.																		*/
/* Para que dicho envio se lleve a cabo satisfactoriamente es necesrio tener	*/
/* conectado a la placa un terminal GSM por medio de un cable de conexión RS-232*/
/* paralelo-espejado.															*/
/*																				*/
/* Fecha: 		27/04/06														*/
/* Última modificación: 15/03/06												*/
/* Autores: Miguel Coronado, Antonio José López, Nuria Pérez					*/
/********************************************************************************/
...
/* -----------------------------------------------------------------------------
   Inicialización del sistema. Inicializa UART. 
   FUNCIÓN: __init
   PARÁMETROS: void
   DEVUELVE: void
-------------------------------------------------------------------------------*/
...
/* ------------------------------------------------------------------------------
   Rutina que mantiene el control del programa para evitar que este se ejecute 
   una y otra vez enviando gran cantidad de mensajes
------------------------------------------------------------------------------ */
void end(void) {
...
void bucleMain(void) { 
	...
	//enviaSerie("AT+CMGS=\"+34620110816\"");
	//recibeSerie();
	//CLR_zona_datos();
